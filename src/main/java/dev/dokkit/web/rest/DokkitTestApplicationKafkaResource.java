...
@RestController
@RequestMapping("/api/dokkit-test-application-kafka")
public class DokkitTestApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DokkitTestApplicationKafkaResource.class);
    ...
    public DokkitTestApplicationKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
